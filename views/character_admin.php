<?php
    ...
    if ($CharacterGuide->Get_Project_Count($_SESSION['ID']) > 0) {
        if ($CharacterGuide->Get_Scene_Count($_SESSION['Project_ID']) > 0) {
            ...
            $SearchAll_Scenes = $CharacterGuide->Get_All_Scenes_For_Project($_SESSION['Project_ID']);
            ...
            $DisplayAll_Scenes = $CharacterGuide->Get_All_Scenes_For_Project($_SESSION['Project_ID']);
            ...
            if ($_POST['SearchScene_ID']) {
                ...
                if ($All_Characters) {
                    foreach ($All_Characters as $Character) {
                        ...
                        $All_Scenes = $CharacterGuide->Get_All_Scenes_For_Project($_SESSION['Project_ID']);
            ...
            echo "<center>You need to <a href='?view=scene_admin'>create a scene</a> first.</center>";
        }
    } else {
